...
private:
	...
	std::forward_list<void*>     Byte48PtrList;
	std::forward_list<void*>     Byte60PtrList;
	std::forward_list<void*>     Byte68PtrList;

	std::vector<void*>    MemoryPoolList;
	friend class JobScheduler;
	friend class Coordinate;
	friend class Complex;
	void InitialiseByte8List(void*);
	void InitialiseByte16List(void*);
	void InitialiseByte24List(void*);
	void InitialiseByte32List(void*);
	void InitialiseByte40List(void*);
	void InitialiseByte48List(void*);
	void InitialiseByte60List(void*);
	void InitialiseByte68List(void*);
public:
	MemoryManager() {}
	~MemoryManager() {}
